...
public class SettingsFragment extends PreferenceFragmentCompat implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        if (!(klasse.equals("JG11")||klasse.equals("JG12"))){   //Falls nicht JG11 oder JG12, sollen die Kurswahleinstelllungen ausgeblendet werden
            for (int i=0;i<17;i++){
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        if (sharedPreferences.getString("klasse","n/A").contains("JG")){    //Wenn ein Jahrgang ausgewaehlt wurde
            for (int i=0;i<17;i++){                                         //... die Listeneinstellungen aktivieren
